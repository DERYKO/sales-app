...
part 'stock_take_bean.jorm.dart';

@GenBean()
class StockTakeBean extends Bean<StockTake> with _StockTakeBean {
  StockTakeBean(Adapter adapter) : super(adapter);
  final String tableName = 'stock_takes';
}
